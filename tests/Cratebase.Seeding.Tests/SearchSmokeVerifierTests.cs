...
public sealed class SearchSmokeVerifierTests : IClassFixture<PostgresFixture>
{
    ...
    private static async Task AddCollectionAsync(CratebaseDbContext context, CollectionId collectionId)
    {
    ...
    private static async Task AddSearchSeedDataAsync(CratebaseDbContext context, CollectionId collectionId)
    {
